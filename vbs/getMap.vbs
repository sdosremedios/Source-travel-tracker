...
class locationListObject
	...
	sub Class_Initialize()
		...
		imageFolder = "D:\SdosRemedios\Transporter\Websites\paris.is-found.org\docs\images\maps\"
		baseURL = "maps.googleapis.com/maps/api/staticmap?sensor=false"
		locationXML = "D:\SdosRemedios\Transporter\Websites\paris.is-found.org\docs\xml\locations.xml"
		m_overwrite = true
		m_size = "572x300"
		m_zoom = 14
		
'		xmlDoc.loadXML(httpGet(locationXML))
		xmlDoc.load(locationXML)
